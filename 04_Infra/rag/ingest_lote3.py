#!/usr/bin/env python3
"""Lote 3 — Cialdini, Bernays, Eyal, Godin x2"""
...
LIBROS = [
    {"id": "1-XcEDAK5UGxvbTTS4G5cF8kIRhzqXqPr", "mime": "application/epub+zip",
     "nombre": "Pre-Suasion — Robert Cialdini.epub",
     "titulo": "Pre-Suasión", "autor": "Robert Cialdini", "tema": "persuasion"},

    {"id": "1_cabEGIL77mr_LwIjCYR6ZqZw4FNn0EO", "mime": "application/epub+zip",
     "nombre": "Propaganda — Edward Bernays.epub",
     "titulo": "Propaganda", "autor": "Edward Bernays", "tema": "persuasion"},

    {"id": "1-_n09V0PGE1D9EjfCxDEhvXWH8G269_3", "mime": "application/epub+zip",
     "nombre": "Enganchado (Hooked) — Nir Eyal.epub",
     "titulo": "Enganchado (Hooked)", "autor": "Nir Eyal", "tema": "persuasion"},

    {"id": "1yRGZBN83KyctRC0vK4NhEetOClzgYOEg", "mime": "application/epub+zip",
     "nombre": "La vaca purpura — Seth Godin.epub",
     "titulo": "La vaca púrpura", "autor": "Seth Godin", "tema": "marketing"},

    {"id": "1jYBgMTh1WZTbqjFKksjNoNv-6ugpxkLu", "mime": "application/epub+zip",
     "nombre": "Esto es marketing — Seth Godin.epub",
     "titulo": "Esto es marketing", "autor": "Seth Godin", "tema": "marketing"},
]
    ...
    for i in range(0, len(chunks), EMBED_BATCH):
        ...
        col.upsert(
            ...
            metadatas=[{"source_file":source,"chunk_index":i+j,"titulo":libro["titulo"],
                ...
                "formato_origen":"epub","drive_id":libro["id"],
                "indexed_at":datetime.now().isoformat()} for j in range(len(batch))]
        )
