...
const authors = {
    "Matt_Furey":       'from:matt@mattfurey.com',
    "John_Carlton":     'from:johnc@john-carlton.com',
    "Seth_Godin":       'from:notify@sethgodin.com',
    "T_Harv_Eker":      'from:success@harveker.com',
    "Ben_Settle":       'from:ben@bensettle.com',
    "Maider_Tomasena":  'from:todosuenaigual@substack.com',
    "Ivan_Orange":      'from:hola@ivanorange.com',
    "Vilma_Nunez":      'from:hola@vilmanunez.com',
    "Miguel_Florido":   'from:mflorido@marketingandweb.es',
    "Rosa_Morel":       'from:rosamorel@substack.com',
};
...
async function fetchEmails() {
    ...
    for (const [authorName, query] of Object.entries(authors)) {
        ...
        try {
            ...
            console.log(`\n✅ ${count} correos nuevos descargados para ${authorName}.`);
        } catch (err) {
