...
### 2026-02-24: Hoja de Ruta Oficial (Roadmap)
- **Identidad**: El cerebro de la fábrica se llama **AETER**.
- **Regla**: La prioridad absoluta es **LUA** (Manager Director) hasta que se indique lo contrario. No saltar a otros especialistas sin orden directa.
- **Próximos Agentes (Orden)**:
  1. **LUA** (Refinamiento continuo)
- **Estado**: Foco total en el cerebro (Lua) y agentes especialistas activos (Closer, EMKD, Content).
- **Aplicar en**: Planificación de todas las fases futuras.

### 2026-02-24: Especificar siempre qué terminal
- **Regla**: Nacho trabaja con 4 terminales distintas. SIEMPRE especificar cuál.
- **Terminales disponibles**:
  - **Terminal Ubuntu** → terminal nativa del sistema operativo
  - **Terminal Antigravity** → la que Antigravity ejecuta directamente
  - **Terminal VS Code** → integrada en el editor
  - **Terminal Claude Code** → si usa Claude Code CLI
- **Aplicar en**: Cualquier instrucción que mencione "abre una terminal" o "ejecuta este comando"
