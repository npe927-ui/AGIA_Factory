...
const CRED_FILE = 'gcp-oauth.keys.json';
const TOKEN_FILE = '.gmail_token.json';
const OUT_DIR = path.join(__dirname, '../../03_Data/Emails_Jesus_Alonso');

const authors = {
    "Jesus_Alonso_Gallo": 'from:jesus@jesusalonsogallo.com OR "jesus alonso gallo" OR from:jesus'
};
