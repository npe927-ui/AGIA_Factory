...
const navItems: NavItem[] = [
  ...
  { href: '/manager', label: 'Manager Agent', icon: SparklesIcon, roles: ['admin', 'lawyer', 'client'], tourId: 'manager' },
  { href: '/projects', label: 'Agentes y Proyectos', icon: BriefcaseIcon, roles: ['admin', 'client'], tourId: 'projects' },
    ...
    <aside data-tour="sidebar" className="fixed left-0 top-0 bottom-0 w-64 bg-primary-500 text-white flex flex-col z-40">
      ...
      <div className="p-6 border-b border-white/10">
        <Link href="/dashboard" className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-heading font-semibold text-lg">Agia 360</h1>
            <p className="text-xs text-white/60">Agencia de IA</p>
          </div>
        </Link>
      </div>
